...
const BlockCommentContent = ({
  ...
  const discussionsCount = resolvedDiscussions.reduce(
    (total, discussion) => total + discussion.comments.length,
    0
  );
  ...
  return (
    <div className="flex w-full justify-between">
      <Popover
        ...
        onOpenChange={(_open_) => {
          if (!_open_ && isCommenting && draftCommentNode) {
            // Clean up draft comment nodes from editor
            ...
            // Clean up empty discussion from discussions array
      ...
      >
        ...
        {/* Hidden trigger for draft comments only */}
        {isCommenting && (
          <div className="relative left-0 size-0 select-none opacity-0 pointer-events-none">
